...
extra/users.h \
extra/workers.h \
EliminaFileServer.sh \
relazione.pdf

# inserire il nome del tarball: es. NinoBixio
TARNAME=GiovanniBartolomeo530375
...
# metto roba solo per appesantirla altrimenti se è piccola falliscono i test perchè
#il test 3 riesce a mandare il file 
OBJECTS		= funcs.o chatty.o client.o
